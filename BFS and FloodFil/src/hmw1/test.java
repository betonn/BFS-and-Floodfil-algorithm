...
//--------------------------------------------------------
        ...
        String path = "C:\\Users\\m_722\\IdeaProjects\\graphs\\src\\hmw1\\sampleinput1.txt"; // to get the file
        ...
        String path1 = "C:\\Users\\m_722\\IdeaProjects\\graphs\\src\\hmw1\\sampleinput1_2.txt"; // to get the file
        main m1 = new main(); //main object


        int[] arr1; // to keep numbers that been returned from reader.


        m1.addVertex(); // calling to vertex method to create graph.
        ArrayList<String> list1 = m1.reader(path1);
        arr1 = new int[Integer.parseInt(list1.get(2))];
        for (
                int i = 0;
                i < arr1.length; i++) {
            arr1[i] = Integer.parseInt(list1.get(i + 3));

        }


        m1.findPath(arr1, Integer.parseInt(list1.get(0)), Integer.parseInt(list1.get(1))); // find paths and returns the result.
